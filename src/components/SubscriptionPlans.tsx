    ...
    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-4 border border-blue-200">
      ...
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center space-x-2">
          ...
          <h3 className="font-semibold text-gray-900 capitalize">{currentPlan}</h3>
        </div>
      ...
      <div className="flex gap-2">
        {currentPlan === 'freemium' ? (
          <button
            ...
            disabled={upgrading}
            className="flex-1 px-3 py-2 bg-gradient-to-r from-yellow-500 to-orange-500 text-white rounded-lg hover:from-yellow-600 hover:to-orange-600 transition-all disabled:opacity-50 text-sm font-medium"
          >
          ...
          <button
            ...
            disabled={upgrading}
            className="flex-1 px-3 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors disabled:opacity-50 text-sm font-medium"
          >
