                ...
                <div className="mb-3 px-2 py-1">
                  <div className="flex items-center gap-2">
                    <div className="w-3 h-3 bg-blue-200 rounded-full flex items-center justify-center">
                      <Navigation className="w-2 h-2 text-blue-500" />
                    </div>
              ...
              {markersToDisplay.map((marker) => {
                ...
                return (
                  <button
                    ...
                    onMouseLeave={(e) => {
                      e.currentTarget.style.backgroundColor = isNearby && showNearbyPlaces ? 'rgba(59, 130, 246, 0.1)' : 'transparent'
                    }}
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {showNearbyPlaces && distance > 0 && (
                        <p className={`text-xs font-medium mt-1 ${
                          isNearby ? 'text-blue-600' : 'text-gray-600'
                        }`}>
